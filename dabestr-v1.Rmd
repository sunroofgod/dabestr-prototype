...
```{r}
dabest_plot(dabest_obj.median_diff, TRUE)
dabest_plot(dabest_obj.median_diff, FALSE)
```
...
my.data.proportional <- data.frame(
  Group = sample(c("Control1", "Control2", "Group1", "Group2", "Group3"), 5000, TRUE)
)
my.data.proportional$Success <- numeric(nrow(my.data.proportional))
my.data.proportional$Success[sample(nrow(my.data.proportional), 2500)] <- 1
```
