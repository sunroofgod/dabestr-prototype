...
```{r}
dabest_obj.colour_paired_mean_diff <- load(data = my.data, x = Group, y = Measurement, idx = c("Control1", "Group1"), is_paired = TRUE, id_col = ID, colour = Gender) %>%
  mean_diff()

dabest_plot(dabest_obj.colour_paired_mean_diff, TRUE, custom_palette = "ucscgb")
dabest_plot(dabest_obj.colour_paired_mean_diff, FALSE, custom_palette = "ordinal")
```
...
dabest_plot(dabest_obj_proportional.cohens_h, TRUE, custom_palette = "brewer")
