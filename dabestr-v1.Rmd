...
```{r}
dabest_obj_multigroup_minimeta <- load(data = my.data, x = Group, y = Measurement, minimeta = TRUE, idx = list(c("Control1", "Group1"), c("Control2", "Group2", "Group3")))
...
dabest_obj_multigroup_minimeta.mean_diff$boot_result <- 
  rbind(dabest_obj_multigroup_minimeta.mean_diff$boot_result, dabest_obj_multigroup_minimeta.mean_diff$boot_result[3,])
