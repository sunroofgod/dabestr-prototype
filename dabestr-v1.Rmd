...
```{r}
pdf(file = "assets/2group/2group_float_true.pdf",
    width = 5.5,
    height = 5.5,
    pointsize = 12)
dabest_plot(dabest_obj.mean_diff, TRUE)
...
pdf(file = "assets/2group/2group_float_false.pdf",
    width = 5.5,
    height = 7,
    pointsize = 12)
...
```{r}
png(file = "assets/2group/2group_float_true.png",
    width = 5.5,
    height = 5.5,
    units = "in",
    pointsize = 12,
...
jpeg(file = "assets/2group/2group_float_false.jpeg",
    width = 5.5,
    height = 7,
    units = "in",
    pointsize = 12,
...
## testing export as pdf/png/jepg
```{r}
pdf(file = "assets/multigroup/multigroup_unpaired.pdf",
    width = 5.5,
    height = 7,
    pointsize = 12)
...
```{r}
png(file = "assets/multigroup/multigroup_unpaired.png",
    width = 5.5,
    height = 5.5,
    units = "in",
    pointsize = 12,
...
jpeg(file = "assets/multigroup/multigroup_unpaired_colour.jpeg",
    width = 7,
    height = 5.5,
    units = "in",
    pointsize = 12,
...
```{r}
png(file = "assets/multigroup/multigroup_sequential.png",
    width = 5.5,
    height = 5.5,
    units = "in",
    pointsize = 12,
...
jpeg(file = "assets/multigroup/multigroup_baseline_colour.jpeg",
    width = 7,
    height = 5.5,
    units = "in",
    pointsize = 12,
    ...
    quality = 100,
    bg = "white")
dabest_plot(dabest_obj.colour_baseline_mean_diff, FALSE)
dev.off()
```
...
```{r}
png(file = "assets/proportion/2group_proportion_float_false.png",
    width = 5.5,
    height = 5.5,
    units = "in",
    pointsize = 12,
...
png(file = "assets/proportion/2group_proportion_float_true.png",
    width = 5.5,
    height = 5.5,
    units = "in",
    pointsize = 12,
...
jpeg(file = "assets/proportion/multigroup_proportion.jpeg",
    width = 5.5,
    height = 5.5,
    units = "in",
    pointsize = 12,
...
## multi sankey
```{r}
dabest_plot(dabest_obj_baseline_sankey.mean_diff, FALSE)
dabest_plot(dabest_obj_sequential_sankey.mean_diff, FALSE)
```
```{r}
png(file = "assets/proportion/2group_sankey_float_true.png",
    width = 5.5,
    height = 5.5,
    units = "in",
    pointsize = 12,
...
png(file = "assets/proportion/multigroup_sankey_baseline.png",
    width = 5.5,
    height = 5.5,
    units = "in",
    pointsize = 12,
...
jpeg(file = "assets/proportion/multigroup_sankey_sequential.png",
    width = 5.5,
    height = 5.5,
    units = "in",
    pointsize = 12,
...
```{r}
png(file = "assets/minimeta/multigroup_minimeta.png",
    width = 7,
    height = 5.5,
    units = "in",
    pointsize = 12,
...
## unpaired
```{r}
dabest_obj_multigroup_deltadelta <- load(data = my.data, x = Genotype, y = Measurement, delta2 = TRUE, experiment =Treatment, idx = list(c("W Placebo","M Placebo"),c("W Drug","M Drug")), colour = Genotype)
...
## paired
```{r}
dabest_obj_multigroup_deltadelta_baseline <- load(data = my.data, x = Treatment, y = Measurement, delta2 = TRUE, experiment = Genotype,idx = list(c("Placebo W","Drug W"),c("Placebo M","Drug M")), paired = "baseline", id = ID, colour = Rep)

dabest_obj_multigroup_deltadelta_baseline.mean_diff <- mean_diff(dabest_obj_multigroup_deltadelta_baseline)

dabest_plot(dabest_obj_multigroup_deltadelta_baseline.mean_diff, TRUE)
```

```{r}
png(file = "assets/deltadelta/multigroup_deltadelta_unpaired.png",
    width = 7,
    height = 5.5,
    units = "in",
    pointsize = 12,
...
png(file = "assets/deltadelta/multigroup_deltadelta_paired.png",
    width = 7,
    height = 5.5,
    units = "in",
    pointsize = 12,
    res = 1200,
    bg = "white")
dabest_plot(dabest_obj_multigroup_deltadelta_baseline.mean_diff, FALSE)
dev.off()
```
