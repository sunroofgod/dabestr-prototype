...
## Loading Data
```{r}
two_groups_paired_sequential <- load(df, x = Group, y = Measurement,
...
```{r}
two_groups_paired_baseline <- load(df, x = Group, y = Measurement,
                                   idx = c("Control 1", "Test 1"),
...
```{r, eval = FALSE}
dabest_plot(two_groups_paired_sequential.mean_diff, float_contrast = FALSE,
            raw_marker_size = 0.5, raw_marker_alpha = 0.3,
            contrast_ylim = c(-0.3, 1.3))
```

```{r, echo = FALSE}
pp_plot <- dabest_plot(two_groups_paired_sequential.mean_diff, float_contrast = FALSE,
                       raw_marker_size = 0.5, raw_marker_alpha = 0.3,
                       contrast_ylim = c(-0.3, 1.3))
...
```{r, eval = FALSE}
dabest_plot(two_groups_paired_baseline.mean_diff, float_contrast = FALSE,
            raw_marker_size = 0.5, raw_marker_alpha = 0.3,
            contrast_ylim = c(-0.3, 1.3))
```

```{r, echo = FALSE}
pp_plot <- dabest_plot(two_groups_paired_baseline.mean_diff, float_contrast = FALSE,
                       raw_marker_size = 0.5, raw_marker_alpha = 0.3,
                       contrast_ylim = c(-0.3, 1.3))
...
```{r}
sequential_repeated_measures.mean_diff <- load(df, x = Group, y = Measurement,
                                     idx = c("Control 1", "Test 1",
                                             "Test 2", "Test 3"),
                                     paired = "sequential", id_col = ID) %>%
  mean_diff()
...
```{r}
baseline_repeated_measures.mean_diff <- load(df, x = Group, y = Measurement,
                                             idx = c("Control 1", "Test 1",
                                                     "Test 2", "Test 3"),
                                             paired = "baseline", id_col = ID) %>%
  mean_diff()
...
```{r}
multi_baseline_repeated_measures.mean_diff <- load(df, x = Group, y = Measurement,
