...
```{r, eval = FALSE}
unpaired_delta2 <- load(df, x = Genotype, y = Measurement,
...
```{r}
unpaired_delta2_specified.mean_diff <- load(df, x = Genotype, y = Measurement,
                                            experiment = Treatment, colour = Genotype,
                                            delta2 = TRUE,
...
```{r}
paired_delta2.mean_diff <- load(df, x = Treatment, y = Measurement,
                                experiment = Genotype, colour = Rep,
                                delta2 = TRUE,
                                idx = list(c("Placebo W","Drug W"),
                                           c("Placebo M","Drug M")),
