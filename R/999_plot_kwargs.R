...
#' - `es_line_size` Default 0.8. Numeric value determining the size of the tufte line in the delta plot.
#' - `raw_marker_spread` Default 2. The distance between the points if it is a swarm plot.
#' - `raw_marker_side_shift` Default 0. The horizontal distance that the swarm plot points are moved.
...
#' - `show_mini_meta` Default FALSE. Boolean value determining if the weighted average plot is shown. If False, the resulting graph would be identical
