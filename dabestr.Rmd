...
dabest_plot(dabest_obj_multigroup.mean_diff, FALSE, custom_palette = "jama", zero_dot = TRUE, raw_marker_side_shift = 0.2, raw_marker_spread = 2, asymmetric_side = "left")
```
