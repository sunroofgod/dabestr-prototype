...
## no idx
```{r}
dabest_obj_multigroup_deltadelta_no_idx <- load(data = my.data, x = Genotype, y = Measurement, delta2 = TRUE, experiment = Treatment, colour = Genotype)
...
## setting levels
```{r}
dabest_obj_multigroup_deltadelta_levels <- load(data = my.data, x = Genotype, y = Measurement, delta2 = TRUE, experiment = Treatment, colour = Genotype, experiment_label = c("Placebo", "Drug"), x1_level = c("W", "M"))
